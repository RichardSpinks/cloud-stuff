sap.ui.jsview("e2e-nwcloud-app-persons-list-web.personsdata", {
      ...
      getControllerName : function() {
         return "e2e-nwcloud-app-persons-list-web.personsdata";
      },
      ...
      createContent : function(oController) {
    	...
    	// toolbar
    	  var oTableToolbar =  sap.ui.commons.Toolbar();
    	 ...
    	 // last name field
    	    ...
    	    var oLastNameField = new sap.ui.commons.TextField({
    	     ...
    	     var oAddPersonButton = new sap.ui.commons.Button({
    	          ...
    	          text : "Add Person",
    	          press : function() {
    	           oController.addNewPerson(sap.ui.getCore().getControl("firstNameFieldId").getValue(),
