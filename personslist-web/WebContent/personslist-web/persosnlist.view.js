sap.ui.jsview("personslist-web.persosnlist", {
	...
	*/ 
	getControllerName : function() {
		return "personslist-web.persosnlist";
	},
...
//		return myButton;
		...
		var oAddPersonButton = new sap.ui.commons.Button({ 
				...
				press : function() { 
					...
					"firstNameFieldId").getValue(), sap.ui.getCore().getControl("lastNameFieldId").getValue(), oTable); 
					} 
			}); 
